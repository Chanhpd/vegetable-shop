			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<div class="block-23 mb-3">
						<ul>
							<li><span class="icon icon-map-marker"></span><span class="text">470 Tran Dai Nghia Street, Ngu Hanh Son District, Da Nang City</span></li>
							<li><a href="#"><span class="icon icon-phone"></span><span class="text">+84 858 687 88</span></a></li>
							<li><a href="#"><span class="icon icon-envelope"></span><span class="text">Vegefood@gmail.com</span></a></li>
						</ul>
					</div>
				</div>
			</div>
